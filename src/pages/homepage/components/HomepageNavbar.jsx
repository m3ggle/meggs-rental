...
const HomepageNavbar = () => {
  return (
    <div className="fixed top-0 left-0 flex items-center justify-between rounded-b-lg bg-white/20 h-fit w-full py-6 px-14 backdrop-blur-sm dark:bg-dmGrey900/20">
      {/* logo */}
