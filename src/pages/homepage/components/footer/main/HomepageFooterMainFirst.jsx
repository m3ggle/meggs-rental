  ...
  return (
    <div className="flex w-full flex-col gap-y-6 1200:p-6">
      ...
      <div
        ...
        } pb-2 duration-300 700:pt-3 1200:px-3 1200:pt-6 1200:pb-3`}
      >
        <motion.i
          variants={inViewItemVariants}
        ...
        <motion.input
          variants={inViewItemVariants}
          autoCorrect="off"
          className="w-full bg-transparent text-2xl text-lmGrey800 placeholder:text-dmGrey300 focus:outline-none dark:text-dmGrey25 1200:text-4xl"
