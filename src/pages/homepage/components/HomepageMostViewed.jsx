...
const HomepageMostViewed = () => {
  ...
  return (
    <div
      id="mostViewed"
      className="hideScrollbar flex w-full flex-col items-center gap-x-6 overflow-x-scroll bg-white py-16 700:py-[100px] 1200:gap-y-6"
    >
      <div className="flex w-full flex-col gap-y-6 px-6 700:hidden">
        ...
        <span className="w-[297px] text-lg text-lmGrey800 drop-shadow-sm 700:text-xl 1200:text-2xl">
      ...
      <div className="hideScrollbar flex w-full items-center gap-x-6 overflow-x-scroll py-1 1200:py-0 1200:flex-col 1200:gap-y-6">
        <div className="flex flex-row-reverse gap-x-6 1200:flex-row 1200:items-end">
          <div className="flex h-fit flex-col  gap-y-3 rounded-[24px] p-9 shadow">
            <h3 className="text-3xl text-lmGrey800 drop-shadow-sm">
              This Week
            </h3>
        ...
        <div className="flex items-start gap-x-6">
          <div className="relative hidden h-[457px] w-[312px] rounded-[24px] shadow 1200:flex">
            <img
