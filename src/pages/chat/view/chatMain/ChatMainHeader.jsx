...
const ChatMainHeader = () => {
  return (
    <div className="flex w-full items-center justify-between gap-y-2 px-6 pb-6 pt-9 min-h-[106px]">
      ...
      />
      <div className="fa-solid fa-bars-staggered rotate-180 text-[24px] text-lmGrey300 flex h-12 w-12 rounded-full hover:bg-lmGrey50 cursor-pointer items-center justify-center hover:text-lmGrey600 duration-300" />
    </div>
  );
}
