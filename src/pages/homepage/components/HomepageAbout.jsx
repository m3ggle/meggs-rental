...
const HomepageAbout = () => {
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-start gap-y-6 1000:items-center">
        ...
        <div className="flex w-full gap-x-3">
          ...
          <div className="w-full max-w-[480px] rounded-[24px] bg-white p-6 shadow dark:bg-dmGrey900 dark:shadow-dmShadow">
            <motion.span
              variants={inViewItemVariants}
              className="text-base text-lmGrey600 dark:text-dmGrey100 700:text-xl"
            >
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute bottom-[120px] left-8 z-10 w-fit 400:bottom-[140px] 400:left-14 700:bottom-[120px] 700:left-[160px]"
      >
        <HomepageComment
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute right-[0%] top-[440px] z-10 w-fit opacity-50 500:top-[360px] 500:right-[24%] 700:top-[420px] 1200:right-[40%] 1200:top-[500px]"
      >
        <HomepageComment
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute top-[600px] right-0 z-10 w-fit opacity-90 400:bottom-auto 400:top-[580px] 1000:bottom-auto 1000:top-[280px] 1000:right-auto 1000:left-[640px]"
      >
        <HomepageComment
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute bottom-[200px] right-[132px] z-10 hidden w-fit 1200:flex"
      >
        <HomepageComment
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute -top-10 left-[68%] w-fit opacity-70 400:top-[4%]"
      >
        <HomepageSocial
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute -bottom-10 right-[60px] z-20 w-fit opacity-40 500:bottom-auto 500:right-auto 500:top-[420px] 500:left-[12px] "
      >
        <HomepageSocial
      ...
      <motion.div
        variants={inViewItemVariants}
        className="absolute -bottom-10 right-[144px] z-20 hidden w-fit opacity-20 400:bottom-6 500:flex 1000:right-auto 1000:bottom-[52px] 1000:left-[528px]"
      >
        <HomepageSocial
